...
namespace Web2.Controllers
{
    public class TicketsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Ticket.Include(t => t.TheatreShow).Include(t => t.User);
        ...
        {
            ViewData["TheatreShowId"] = new SelectList(_context.TheatreShow, "Id", "Title");
        ...
        public async Task<IActionResult> Create([Bind("Id,Price,TheatreShowId,UserId")] Ticket ticket)
        {
            ...
            ViewData["TheatreShowId"] = new SelectList(_context.TheatreShow, "Id", "Id", ticket.TheatreShowId);
        ...
        public async Task<IActionResult> Edit(Guid? id)
        {
            ...
            ViewData["TheatreShowId"] = new SelectList(_context.TheatreShow, "Id", "Title", ticket.TheatreShowId);
